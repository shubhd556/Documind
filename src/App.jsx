    ...
    setTimeout(
      () =>
        setLoadingState((prev) => ({
          ...prev,
          step: "Scanning for context matches...",
        })),
      1200,
    );
    setTimeout(
      () =>
        setLoadingState((prev) => ({
          ...prev,
          step: "Synthesizing neural response...",
        })),
      3000,
    );
      ...
      <div className="auth-screen">
        ...
        <main className="hero-content">
          ...
          <p className="hero-subtitle">
            The world's first browser-native PDF intelligence. No data leaves
            your machine. No subscriptions. Just pure local power.
          </p>
